...
python3 binary_rewrite.py --binary_path /home/zrz0517/study/chain_attestation/rt-ateest/zrz-attest/embench_test/bd/src/"$1"/"$1" --disassembly_file_name /home/zrz0517/study/chain_attestation/rt-ateest/zrz-attest/embench_test/bd/src/"$1"/"$1".S --only_called_once_func_file ../output/only_called_once_func_backup_"$1".txt --ToInsertFuncFile ../output/ToInsertFunc_"$1".txt --output_binary_path ../output/"$1"_output || { echo "Binary rewrite failed"; exit 1; }
